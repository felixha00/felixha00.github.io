...
i'm **Felix**, a 🍁 software engineer with a passion in engineering products on the web and improving/learning new skills.   
...
btw this site is made in `Astro + Svelte`. check out the [source code](https://github.com/felixha00/felixha00.github.io)