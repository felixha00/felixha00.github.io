  ...
  return (
    <button
      className={cn(
        ...
        !isPressed &&
          !disabled && ["shadow-[0_4px_0_0_#9ca3af,0_6px_8px_0_rgba(0,0,0,0.15)]", "translate-y-0"],

        // 3D effect - pressed state
        isPressed &&
          !disabled && ["shadow-[0_1px_0_0_#9ca3af,0_2px_4px_0_rgba(0,0,0,0.1)]", "translate-y-1"],
        ...
        disabled && [
          ...
          "shadow-[0_2px_0_0_#d1d5db,0_3px_4px_0_rgba(0,0,0,0.1)]",
        ],
