...
const INITIAL_SECTIONS = [
  ...
  },
  {
    key: "bio",
    label: "Bio",
    icon: <UserSquare2Icon className="size-3" />,
    href: "/bio",
  },
  ...
  // { key: "content", label: "Content Creation", icon: <Video className="size-3" /> },
  {
    key: "projects",
    label: "Projects",
    icon: <Layers2 className="size-3" />,
    href: "/projects",
  },
  {
    key: "Gallery",
    label: "Gallery",
    icon: <FrameIcon className="size-3" />,
    href: "/gallery",
  },
];
              ...
              return (
                ...
                >
                  ...
                  <TabsTrigger
                    ...
                    value={s.key}
                    className={cn(
                      "flex items-center gap-2 px-2 relative z-10 data-[active=true]:inset-shadow-sm data-[active=true]:inset-shadow-background/50 cursor-pointer",
                      isCustomTab && "pr-6",
                    )}
                  >
                    <Link href={s.href}>
