...
const components: MDXComponents = {
    ...
    blockquote: (props: any) => (
        <blockquote {...props} className='border bg-muted/50  p-2 rounded prose-headings:m-0 not-italic leading-tight !before:[&_p:first-of-type]:content-none !after:[&_p:last-of-type]:content-none' />
    ),
    ImgWindow: (props: any) => {
        return <Card className='p-0 relative rounded flex flex-col gap-0 not-prose mb-4'>
