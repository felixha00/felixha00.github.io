...
const Navbar = () => {
    ...
    return (
        <nav className='z-50 fixed top-0 left-0 right-0 p-4 flex items-center justify-between'>
            <div ref={containerRef} className='grid grid-cols-1 grid-rows-1 items-center'>

                {/* Name */}
                <h1
                    ref={nameRef}
                    className='col-start-1 row-start-1 text-2xl font-bold opacity-100 tracking-tight -translate-y-0.5'
                >
                    felix ha
                </h1>
            ...
            /> */}
            <button>Menu</button>
            <div className='bg-white/10 h-10 w-40 absolute top-0 left-1/2 -translate-x-1/2 rounded-b-2xl flex justify-center flex-row'>yo</div>
        </nav>
    );
}
